...
export function TournamentPage({ allPokemon }) {
        ...
        return (
            <div className="tournament-page">
                ...
                <div className="setup-controls">
                    <button className="autofill-btn" onClick={autoFill}>Relleno Automático (8)</button>
                    <button
                        className="start-btn"
    ...
    if (view === 'champion') {
        return (
            <div className="tournament-page champion-view">
    ...
    return (
        <div className="tournament-page">
            ...
            <TournamentBracket rounds={rounds} currentMatch={currentMatch} />
