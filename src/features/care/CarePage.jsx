  ...
  return (
    <div className="care-page">
      ...
      <section className="hospital-section">
        <div className="hospital-card">
          <div className="hospital-info">
            <h2>
              <Heart className="icon red" /> Centro Pokémon
            </h2>
      ...
      <section className="canteen-section">
        <h2>
          <Utensils className="icon orange" /> Comedor
        </h2>
          ...
          {squadPokemon.map(pokemon => {
            ...
            return (
              <div key={pokemon.id} className="pokemon-care-card">
                ...
                <div className="care-stats">
                  <div className="stat-bar-group">
                    ...
                    <div className="care-bar-bg">
                      <div className="care-bar-fill hp" style={{ width: `${stats.hp}%` }}></div>
                    </div>
                  </div>
                  ...
                  <div className="stat-bar-group">
                    ...
                    <div className="care-bar-bg">
                      <div
                        ...
                        style={{
                          width: `${stats.fatigue || 0}%`,
                          background: (stats.fatigue || 0) > 50 ? '#f59e0b' : '#64748b',
                        }}
                      ></div>
                    </div>
                  </div>
                ...
                <button className="feed-btn" onClick={() => handleFeed(pokemon.id)}>
                  <Utensils size={16} /> Alimentar (
                  <img src={bagIcon} alt="coins" className="coin-icon-inline" /> 20)
                </button>
              </div>
            );
          })}
