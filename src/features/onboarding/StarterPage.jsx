...
const STARTERS = [
  {
    ...
    type: 'grass',
    description:
      'Een Gras/Gif Pokémon. Hij draagt een zaadje op zijn rug dat groeit naarmate hij ouder wordt.',
  },
  {
    id: 4,
    name: 'Charmander',
    type: 'fire',
    description: 'Een Vuur Pokémon. De vlam op zijn staart toont zijn gezondheid en stemming.',
  },
  {
    id: 7,
    name: 'Squirtle',
    type: 'water',
    description:
      'Een Water Pokémon. Zijn schild biedt niet alleen bescherming, maar helpt ook bij het zwemmen.',
  },
  {
    id: 25,
    name: 'Pikachu',
    type: 'electric',
    description:
      'Een Elektrische Pokémon. Hij slaat elektriciteit op in zijn wangen om vijanden te schokken.',
  },
];
    ...
    >
      <div className="starter-content">
        <div className="starter-header">
          <h1 style={{ textShadow: '2px 2px 0 #000', fontFamily: '"Press Start 2P", cursive' }}>
            Welkom, Trainer!
          </h1>
          <p
            className="subtitle"
          ...
          >
            Kies je eerste Pokémon partner om je avontuur te beginnen.
          </p>
        </div>
        ...
        <div className="starters-grid">
          {STARTERS.map(starter => (
            ...
            >
              ...
              <p style={{ fontSize: '0.6rem', lineHeight: '1.4', marginTop: '0.5rem' }}>
                {starter.description}
              </p>
            </div>
          ))}
