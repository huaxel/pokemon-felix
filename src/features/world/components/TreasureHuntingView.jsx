  ...
  return (
    <div className="treasure-hunt-page hunting">
      ...
      <div className="hunt-content">
        ...
        {message && (
          <div
            className={`hunt-message ${
              message.includes('dichtbij') ? 'hot' : message.includes('warmer') ? 'warm' : 'cold'
            }`}
          >
            {message}
          </div>
        ...
        <div className="hunt-guide">
          ...
          <ul>
            <li>
              <strong>X = 0</strong>: Ver West (linkerkant)
            </li>
            <li>
              <strong>X = 9</strong>: Ver Oost (rechterkant)
            </li>
            <li>
              <strong>Y = 0</strong>: Ver Noord (bovenkant)
            </li>
            <li>
              <strong>Y = 9</strong>: Ver Zuid (onderkant)
            </li>
          </ul>
        </div>
      </div>
