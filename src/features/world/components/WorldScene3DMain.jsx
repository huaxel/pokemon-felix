...
export function WorldScene3DMain({ mapGrid, onObjectClick, isNight = false, enableSky = true }) {
  ...
  return (
    <>
      <ambientLight intensity={isNight ? 0.25 : 0.7} color={isNight ? '#0f172a' : '#ffffff'} />
      <directionalLight
        position={[10, 20, 10]}
