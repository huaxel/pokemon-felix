...
const EVOLUTIONS = {
    ...
    '29': '30', '30': '31', // NidoranF -> Nidorina -> Nidoqueen
    '32': '33', '33': '34', // NidoranM -> Nidorino -> Nidoking
...
export function EvolutionPage() {
    ...
    const evolvable = pokemonList.filter(p =>
        ownedIds.includes(p.id) && EVOLUTIONS[p.id.toString()]
    );
    ...
    return (
        <div className="evolution-page">
            ...
            {evolutionResult && (
                <div className="result-overlay">
                    <div className="result-card">
                        ...
                        <button className="confirm-btn" onClick={() => setEvolutionResult(null)}>Geweldig!</button>
                    </div>
                </div>
            )}
            ...
            <div className="evo-intro">
                ...
                <p>Evolueer je Pokémon naar hun sterkere vorm voor 300 munten. Bekijk wie er klaar voor is!</p>
            </div>
