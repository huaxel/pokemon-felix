...
export function SafariZone3D() {
  ...
  const { encounter, setEncounter, catching, catchMessage, handleCatch, handleFlee } = useEncounter(
    {
      onFleeCustom: () => {
  ...
  return (
    <div className="safari-container">
        ...
        <Suspense fallback={null}>
          ...
          {pokemonList.slice(0, 8).map((p, i) => (
            <PokemonSprite
              ...
              pokemon={p}
              position={[Math.sin(i * 0.5) * 10, 1, Math.cos(i * 0.5) * 10]}
              orbit={{
                radius: 1.5 + (i % 3) * 0.4,
                speed: 0.5 + i * 0.07,
      ...
      <div className="safari-ui-layer pointer-events-none">
        ...
        {encounter && (
          <div
            className="encounter-overlay pointer-events-auto"
            style={{
              position: 'absolute',
              top: 0,
              left: 0,
